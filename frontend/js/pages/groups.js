    ...
    try {
        ...
        content.innerHTML = `
            <div class="card"><div class="card-body">
                ...
                <button class="btn btn-primary" onclick="if(navigator.onLine){{renderGroups()}}else{{showToast('You are still offline. Please connect to the internet.', 'warning')}}">Retry</button>
            </div></div>
        `;
    }
}
